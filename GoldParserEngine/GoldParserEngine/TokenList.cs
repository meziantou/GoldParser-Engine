...
{
    public class TokenList : IReadOnlyList<Token>
    {
        readonly List<Token> _list = new List<Token>();
        ...
        internal bool Remove(Token item)
        {
        ...
        internal void Insert(int index, Token item)
        {
